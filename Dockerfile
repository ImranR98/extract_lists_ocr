# Adapted from https://raw.githubusercontent.com/JaidedAI/EasyOCR/refs/heads/master/Dockerfile
...
RUN python -m pip install opencv-python-headless scikit-learn
COPY extract_lists.py .
CMD ["python", "extract_lists.py", "/images"]